...
import kotlinx.android.synthetic.main.fragment_growth_recording.*
...
import np.com.sudan10.lims_v30.data.repository.GrowthRepository
import np.com.sudan10.lims_v30.databinding.FragmentGrowthRecordingBinding
import np.com.sudan10.lims_v30.ui.base.BaseFragment
import java.util.*

class GrowthRecording : BaseFragment<GrowthRecordingViewModel, FragmentGrowthRecordingBinding,GrowthRepository>() {
    ...
    override fun getViewModel() = GrowthRecordingViewModel::class.java

    override fun getFragmentBinding() = R.layout.fragment_growth_recording

    override fun getFragmentRepository(): GrowthRepository {
        val token = runBlocking { userPreferences.authToken.first() }
        val api = remoteDataSource.buildApi(GrowthApi::class.java, token)
        return GrowthRepository(api)
    }
